...
public class MeshOptimizer {
     ...
     * @return
     */
    public static Mesh generateOptimizedMesh(Chunk blockChunk, MeshMerger meshMerger) {
        loadMeshData(blockChunk, meshMerger);
        return generateMesh();
    }

    private static void loadMeshData(Chunk chunk, MeshMerger meshMerger) {
    ...
    private static Vector2f getTextureCoordinates(TextureLocation textureLocation, int xUnitsToAdd, int yUnitsToAdd) {
        // need new settings location
        float textureCount = 10;

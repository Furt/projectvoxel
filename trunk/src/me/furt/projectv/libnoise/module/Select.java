...
import me.furt.projectv.libnoise.exception.ExceptionNoModule;
...
public class Select extends ModuleBase {
    ...
    public double getValue(double x, double y, double z) {
        ...
        if (edgeFalloff > 0.0) {
            if (controlValue < (lowerBound - edgeFalloff)) // The output value from the control module is below the selector
            // threshold; return the output value from the first source module.
            {
                ...
                return Interp.linearInterp(sourceModules[0].getValue(x, y, z),
                        ...
                        alpha);
            } else if (controlValue < (upperBound - edgeFalloff)) // The output value from the control module is within the selector
            // threshold; return the output value from the second source module.
            {
                ...
                return Interp.linearInterp(sourceModules[1].getValue(x, y, z),
                        ...
                        alpha);
            } else // Output value from the control module is above the selector threshold;
